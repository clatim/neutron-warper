...
@fem.integrand
def diffusion_boundary_bilinear_form(s: fem.Sample, domain: fem.Domain, trial_function: fem.Field, test_function: fem.Field, 
                                     xmin_alpha: float, xmax_alpha: float, ymin_alpha: float, ymax_alpha: float):
...
def integrate_linear_form(problem: NeutronProblem, func_space: fem.FunctionSpace, domain: fem.Domain, linear_form, xsec_data: CrosssectionFields):
...
def integrate_bilinear_form(problem: NeutronProblem, geo: fem.Geometry, func_space: fem.FunctionSpace, domain: fem.Domain, xsec_data: CrosssectionFields):
